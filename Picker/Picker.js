...
exports.Picker = function (_a) {
    var _b, _c;
    var date = _a.date, views = _a.views, disableToolbar = _a.disableToolbar, onChange = _a.onChange, openTo = _a.openTo, unparsedMinDate = _a.minDate, unparsedMaxDate = _a.maxDate, ToolbarComponent = _a.ToolbarComponent, orientation = _a.orientation, timeTooltipProps = _a.timeTooltipProps, dateTooltipProps = _a.dateTooltipProps, rest = __rest(_a, ["date", "views", "disableToolbar", "onChange", "openTo", "minDate", "maxDate", "ToolbarComponent", "orientation", "timeTooltipProps", "dateTooltipProps"]);
    ...
    return (React.createElement("div", { className: clsx_1.default(classes.container, (_b = {},
            ...
            _b)) },
        !disableToolbar && (React.createElement(ToolbarComponent, __assign({}, rest, { timeTooltipProps: timeTooltipProps, dateTooltipProps: dateTooltipProps, views: views, isLandscape: isLandscape, date: date, onChange: onChange, setOpenView: setOpenView, openView: openView }))),
