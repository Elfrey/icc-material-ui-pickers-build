...
var Calendar = /** @class */ (function (_super) {
    ...
    Calendar.prototype.render = function () {
        ...
        var _b = this.props, classes = _b.classes, allowKeyboardControl = _b.allowKeyboardControl, leftArrowButtonProps = _b.leftArrowButtonProps, leftTooltipProps = _b.leftTooltipProps, leftArrowIcon = _b.leftArrowIcon, rightArrowButtonProps = _b.rightArrowButtonProps, rightTooltipProps = _b.rightTooltipProps, rightArrowIcon = _b.rightArrowIcon, loadingIndicator = _b.loadingIndicator;
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(CalendarHeader_1.default, { currentMonth: currentMonth, slideDirection: slideDirection, onMonthChange: this.handleChangeMonth, leftArrowIcon: leftArrowIcon, leftArrowButtonProps: leftArrowButtonProps, leftTooltipProps: leftTooltipProps, rightTooltipProps: rightTooltipProps, rightArrowIcon: rightArrowIcon, rightArrowButtonProps: rightArrowButtonProps, disablePrevMonth: this.shouldDisablePrevMonth(), disableNextMonth: this.shouldDisableNextMonth() }),
