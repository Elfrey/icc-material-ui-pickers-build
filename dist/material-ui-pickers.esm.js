...
var KeyboardDateInput = function KeyboardDateInput(_ref) {
  ...
  return createElement(Rifm, {
    ...
    return createElement(TextFieldComponent, _extends({
      ...
      onChange: onChange,
      variant: inputVariant,
      InputProps: _objectSpread$1({}, InputProps, _defineProperty({}, "".concat(position, "Adornment"), createElement(Tooltip, _extends({
        title: "Open calendar"
      }, calendarTooltipProps), createElement(InputAdornment, _extends({
        position: position
...
var CalendarHeader = function CalendarHeader(_ref) {
  ...
  return createElement("div", null, createElement("div", {
  ...
  }, createElement(Tooltip, _extends({
    title: "Previous Month"
  }, leftTooltipProps), createElement(IconButton, _extends({}, leftArrowButtonProps, {
    ...
    align: "center",
    variant: "body1"
  }, utils.getCalendarHeaderText(currentMonth))), createElement(Tooltip, _extends({
    title: "Next Month"
  }, rightTooltipProps), createElement(IconButton, _extends({}, rightArrowButtonProps, {
...
var DateTimePickerTabs = function DateTimePickerTabs(_ref) {
  ...
  return createElement(Paper, null, createElement(Tabs, {
    ...
    title: "Pick date"
  }, dateTooltipProps), createElement(Tab, {
    value: "date",
    icon: createElement(Fragment, null, dateRangeIcon)
  })), createElement(Tooltip, _extends({
    title: "Pick time"
  }, timeTooltipProps), createElement(Tab, {
    value: "time",
