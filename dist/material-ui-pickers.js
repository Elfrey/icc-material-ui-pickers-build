...
var KeyboardDateInput = function KeyboardDateInput(_ref) {
  ...
  return React.createElement(rifm.Rifm, {
    ...
    return React.createElement(TextFieldComponent, _extends({
      ...
      onChange: onChange,
      variant: inputVariant,
      InputProps: _objectSpread$1({}, InputProps, _defineProperty({}, "".concat(position, "Adornment"), React.createElement(Tooltip, _extends({
        title: "Open calendar"
...
var CalendarHeader = function CalendarHeader(_ref) {
  ...
  return React.createElement("div", null, React.createElement("div", {
    ...
    align: "center",
    variant: "body1"
  }, utils.getCalendarHeaderText(currentMonth))), React.createElement(Tooltip, _extends({
    title: "Next Month"
