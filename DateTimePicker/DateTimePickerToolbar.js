...
exports.DateTimePickerToolbar = function (_a) {
    var date = _a.date, openView = _a.openView, setOpenView = _a.setOpenView, ampm = _a.ampm, hideTabs = _a.hideTabs, dateRangeIcon = _a.dateRangeIcon, dateTooltipProps = _a.dateTooltipProps, timeIcon = _a.timeIcon, timeTooltipProps = _a.timeTooltipProps, onChange = _a.onChange;
    ...
    return (React.createElement(React.Fragment, null,
        ...
        showTabs && (React.createElement(DateTimePickerTabs_1.default, { dateRangeIcon: dateRangeIcon, dateTooltipProps: dateTooltipProps, timeIcon: timeIcon, timeTooltipProps: timeTooltipProps, view: openView, onChange: setOpenView }))));
};
